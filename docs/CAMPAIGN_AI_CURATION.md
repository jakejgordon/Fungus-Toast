...
Current authored-board evidence: the legacy-authored `Campaign11` lineup (`AI1`, `AI2`, `AI3`, `AI7`, `AI8`, `AI9`, `AI11`) was rechecked on 2026-03-28 with the safe proxy on the exact `130x130` board and landed at `10.0% (2/20)`, avg living `1032.2`, avg dead `978.0`. That is harsher than the freshly softened `Campaign10`, but not obviously off-band for the first elite-preview level, so the practical better-not-perfect call is to hold the authored board until/unless Campaign12+ retuning shows a stronger reason to smooth this transition.

Current authored-board evidence: the legacy-authored `Campaign12` lineup (`AI1`, `AI2`, `AI3`, `AI10`, `AI7`, `AI8`, `AI9`) was rechecked on 2026-03-28 with the safe proxy on the exact `140x140` board and came out materially softer than the previous day's `0/10` short screen implied. The 20-game seed-`20260328` run landed at `10.0% (2/20)`, avg living `1121.8`, avg dead `1063.0`; the 50-game confirmation with seed `20260329` held exactly at `10.0% (5/50)`, avg living `1156.6`, avg dead `1104.9`. Practical better-not-perfect call: keep the authored board as-is for now instead of softening `AI10` or another elite anchor speculatively.

Current authored-board evidence: the legacy-authored `Campaign13` lineup (`AI1`, `AI2`, `AI3`, `AI10`, `AI1`, `AI7`, `AI8`) was rechecked on 2026-03-28 with the safe proxy on the exact `150x150` board and likewise came back much softer than the previous day's `0/10` short screen implied. The 20-game seed-`20260328` run landed at `15.0% (3/20)`, avg living `1300.2`, avg dead `1177.4`; the 50-game confirmation with seed `20260329` held at `10.0% (5/50)`, avg living `1269.4`, avg dead `1240.6`. Practical better-not-perfect call: keep the authored board as-is for now instead of speculatively softening the duplicate `AI1` anchor.

Current authored-board evidence: the legacy-authored `Campaign14` lineup (`AI1`, `AI2`, `AI3`, `AI10`, `AI1`, `AI2`, `AI7`) was rechecked on 2026-03-28 with the safe proxy on the exact `160x160` board and did **not** rebound like Campaign12-13 did. The 20-game seed-`20260328` run landed at `10.0% (2/20)`, avg living `1537.9`, avg dead `1291.9`, but the 50-game confirmation with seed `20260329` dropped to `4.0% (2/50)`, avg living `1440.5`, avg dead `1213.7`, which puts it back in the practical blocker band.

One conservative softening probe was also tried on that same `160x160` board: replace the duplicate second `AI2` with `AI8` to move from one medium support to two (`AI1`, `AI2`, `AI3`, `AI10`, `AI1`, `AI8`, `AI7`). That short seed-`20260328` screen only managed `5.0% (1/20)`, avg living `1439.9`, avg dead `1399.0`, so the obvious duplicate-elite -> medium-support swap does **not** currently look like the right fix.
