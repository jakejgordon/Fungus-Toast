...
- **Aerated age-cap validation (2026-08-23):** Aerated Frontier now applies only from living cells younger than five Growth Cycles. Focused Core tests cover the age-4/age-5 boundary. The exact prior Aerated-only/Necro 50-game probe, rerun with the same fixed lineup/seed/rotation/disabled systems (`necro_rush_aeratedonly_agecap5_120x120_g50_seed230823`), reduced that route from 48/50 wins (96.0%; 3,221.08 average living cells) to 30/50 (60.0%; 1,862.92). The cap has the intended directional effect and substantially lowers board control, but 60% remains above a healthy competitive range; use this as the baseline for one further narrow retune rather than declaring the interaction resolved.
