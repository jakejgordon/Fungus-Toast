...
- **Current scale:** 36 logical mutations across six categories. The intended expansion is approximately 45 logical mutations, subject to mechanic design and balance validation.
...
- **State:** Substrate Ecology is feature-complete as of 2026-08-23. Its final roster is Aerated Frontier, Crustward Tropism, Compaction Pressure, Detrital Enzymes, Toxin Margin, Necrophytic Bloom, and Toxinborne Seeding. Nutrient Afterglow and Ecological Succession were not selected; unrelated existing-lane concepts remain separate future work.
...
- **Crustward Tropism (2026-08-22):** The vacant Tier-2 Ecology branch is now implemented. It grants +0.75 percentage points per level for five levels to legal attempts that reduce shape-aware playable-edge distance, including enabled Tendril diagonals. At max level, one qualifying playable-crust arrival per player per Growth Cycle is automatic; Simulation records qualifying attempts, bonus-attributable successes, and automatic arrivals.
- **Compaction Pressure (2026-08-23):** The approved Tier-2 sibling branch is implemented at +2 percentage points per level for five levels when a living source has one or two legal orthogonal growth targets; it applies to legal cardinal and enabled Tendril diagonal attempts and never creates an attempt for a sealed source. Detrital Enzymes now uses the general named-prerequisite ANY-group model: level 1 of either Crustward Tropism or Compaction Pressure is sufficient. Existing prerequisites retain their ALL semantics. The mutation inspector shows the alternatives as one branch requirement and the dependency graph retains both valid incoming edges. `TST_EcologyCompactionFirst` targets Compaction, hard-excludes Crustward from paid and automatic spending, then follows the established Ecology/Arch01 runway.
- **Toxin Margin and Necrophytic Bloom (2026-08-23):** Toxin Margin is the implemented Tier-3 toxin-response branch: legal cardinal or enabled Tendril diagonal growth into an empty target orthogonally adjacent to an enemy-owned toxin gains +1.5 percentage points/level for five levels, with Aerated Frontier 5 and Homeostatic Harmony 5 prerequisites. Own toxins and multiple toxin neighbors do not qualify/stack, toxin tiles remain blocked, and Simulation tracks qualifying attempts plus attributable bonus growth. Necrophytic Bloom (ID 18) moved to Tier-4 Substrate Ecology with Autolytic Surge 2, Detrital Enzymes 3, and Adaptive Expression 3 prerequisites; its compost effect, timing, levels, constants, tracking, and save compatibility remain unchanged.
- **Latent Polymorphism (2026-08-23):** The approved Tier-4 Genetic Drift replacement for Bloom is implemented. It requires Mutator Phenotype 7, Adaptive Expression 5, and Anabolic Inversion 3. When a player deliberately banks mutation points, each level pays 10% interest on the pre-interest banked amount, rounded down; the payout caps at 5 bonus mutation points per Mutation Phase and cannot compound in that action. Existing human and AI banking paths, the game log, Simulation tracking, and mutation-tree presentation are wired; no deferred persistence is necessary.
- **Toxinborne Seeding (2026-08-23):** The Tier-5 Substrate Ecology capstone formerly named Mycotoxin Fission now requires Toxin Margin 5, Mycotoxin Potentiation 5, and Putrefactive Mycotoxin 2. Each of its three levels adds +10 percentage points growth chance into an empty target orthogonally adjacent to an owned toxin. A successful qualifying growth relocates the selected toxin to one empty tile next to an enemy living cell, retaining only its remaining lifespan, and carries the newly colonized cell with it. The carried cell lands in a random open orthogonal tile next to the toxin or is lost when no such tile exists; it cannot trigger another seeding. Core rules, Simulation metrics, mutation tree/summary presentation, focused tests, the roster, decision log, and Unity Core DLL/PDB are updated. Manual Unity tree and visual-flow validation remains required.
- **Amplified Fission probe (historical, 2026-08-23):** The prior toxin-split version with +6 percentage points/level and up to three toxin splits/level was tested through `TST_EcologyToxinFissioner` in a 50-game 120x120, four-player, rotated-slot, nutrient/mycovariant-disabled comparison. It won 0/50 (0.0%; 187.76 average living cells, 203.54 dead cells, 65.28 toxins); `TST_Arch01_GrowthResilience` won 45/50 (90.0%; 6,272.36 living), `TST_Arch04_DriftGrowth` 5/50 (10.0%), and `TST_Arch03_FungicideSurge` 0/50. This replaced design should not be used for current balance decisions. Artifact: `toxin_fission_amplified_120x120_g50_seed230826`.
- **Toxinborne Seeding probe (2026-08-23):** The new one-toxin, carried-cell version at +10 percentage points/level was tested through the same `TST_EcologyToxinFissioner` route in a 50-game 120x120, four-player, rotated-slot, nutrient/mycovariant-disabled comparison. It reached max Seeding in 23/50 games (average first acquisition round 14.20), recorded 58 toxin relocations and 43 carried-cell landings, but still won 0/50 (0.0%; 190.40 average living cells, 191.86 dead cells, 48.88 toxins). `TST_Arch01_GrowthResilience` won 43/50 (86.0%; 5,641.96 living), `TST_Arch04_DriftGrowth` 7/50 (14.0%), and `TST_Arch03_FungicideSurge` 0/50. The remote footholds work mechanically but do not rescue this dedicated toxin rush; do not add it to the normal pool from this result. Artifact: `toxinborne_seeding_120x120_g50_seed230827`.
- **Compaction first result (2026-08-23):** Artifact-backed 50-game 120x120 comparison `ecology_compaction_vs_crust_120x120_g50_seed230823` used the explicit Compaction-first, Crust-first, Arch01, and Arch04 lineup with slot rotation, nutrients off, and mycovariants off. Zero parity mismatches. Compaction-first won 12/50 (24.0%; 1,931.6 average living cells), Crust-first 13/50 (26.0%; 2,088.6), Arch01 13/50 (26.0%; 2,050.0), and Arch04 12/50 (24.0%; 2,039.6). This first probe places the branch in the intended competitive band, though a 15x15 repeat is still needed before tuning its numbers.
- **Normal-pool Ecology identity probes (2026-08-23):** No new Ecology identity was promoted. In two 50-game 120x120 Proven-roster trials against `Growth/Resilience` and `Creeping>Necrosporulation` (rotated slots; nutrient patches and mycovariants disabled), Crust Forager won 2/50 (4.0%) and the Toxin Fissioner won 0/50 despite reaching Fission consistently. A third run replacing the toxin build with Pressure Forager produced the opposite failure: Pressure Forager won 49/50 (98.0%), while Crust Forager won 0/50. Artifacts: `proven_ecology_identities_120x120_g50_seed230823`, `proven_ecology_identities_v2_120x120_g50_seed230824`, and `proven_ecology_foragers_120x120_g50_seed230825`. Do not add either recipe to the normal pool; a future identity pass needs a new design hypothesis and a mixed-strength baseline before another promotion attempt.
- **Tracer/Bloom toxin identity probe (2026-08-23):** Two mixed variants replaced the failed dedicated toxin rush for a 50-game 120x120, four-player, rotated-slot comparison with nutrients off and mycovariants on. Both take Mycotoxin Tracer first, Mycelial Bloom 7, Creeping Mold, max Sporicidal Bloom, then the Toxin Margin/Seeding chain. `TST_EcologyTracerBloomJetting` explicitly prefers the three Jetting Mycelium variants, then Enduring Toxaphores/Chemotactic Mycotoxins; it won 8/50 (16.0%; 1,006.92 average living cells, 2,246.92 dead cells, 1,045.88 toxins). `TST_EcologyTracerBloomBallistospore` instead prefers Ballistospore Discharge III/II/I, then the same toxin supports; it won 12/50 (24.0%; 1,286.06 living, 2,720.34 dead, 1,319.72 toxins), matching the intended competitive band in this first probe. Both acquired Tracer, max Bloom, and max Seeding in all 50 games (median first upgrade rounds 1, 17, and 29). The preferred drafts were actually sampled: Ballistospore I/II/III appeared 25/10/13 times for the Ballistospore variant; Jetting I/II/III appeared 22/20/12 times for Jetting. Important boundary: the current AI Ballistospore helper targets empty tiles nearest enemy living cells; it does not yet intentionally place a toxin adjacent to its own colony. Keep Ballistospore as a testing-only candidate pending a broader baseline repeat; do not promote Jetting. Artifact: `ecology_tracer_bloom_myco_120x120_g50_seed230828`.
- **Crustward validation (2026-08-22):** Focused Core tests cover definition/prerequisite/cost, strict edge-distance qualification, cardinal attribution, the one-per-cycle reset, and enabled diagonal Tendrils. The canonical Core suite excluding the known unrelated campaign-preset naming assertion passed 549/549; Core and Simulation builds passed with no warnings/errors. A 40x40 seeded two-player Ecology smoke run (`crustward_smoke_seed220822`) had zero parity mismatches and reached the mutation in both strategies. The Expansion strategy recorded 53 automatic crust arrivals over 21 rounds, so later multi-seed balance work should specifically examine max-level edge-rush strength and Perimeter Proliferator synergy. Unity Core DLL/PDB was refreshed; manual Unity compile/tree-layout validation remains required.
- **Ecology AI order (2026-08-23):** `TST_EcologyCrustFirst` buys Aerated Frontier 10, Crustward max, Creeping Mold max, Detrital Enzymes max, Aerated max, then the remaining `TST_Arch01_GrowthResilience` suffix (Hypersystemic Regeneration, Catabolic Rebirth, Necrohyphal Infiltration). `TST_EcologyFrontierFirst` buys Aerated max, Crustward max, Creeping Mold max, Detrital Enzymes max, then that same remaining suffix. This gives both strategies time to create dead matter before investing in Detrital Enzymes, while preserving their distinct Aerated Frontier timing and Arch01 fallback profile.
- **120x120 result (2026-08-22):** The artifact-backed 50-game run `ecology_nerf_120x120_g50_seed220822` used the four fixed Testing strategies above with rotated slots, nutrient patches disabled, and mycovariants disabled. It had zero parity mismatches. `TST_Arch01_GrowthResilience` won 25/50 (50.0%, 2,203.88 average living cells) and `TST_Arch04_DriftGrowth` won 25/50 (50.0%, 2,178.44). `TST_EcologyCrustFirst` and `TST_EcologyFrontierFirst` each won 0/50, averaging 418.62 and 411.66 living cells respectively. This isolated all-in Ecology route is severely underpowered against the selected mature Growth controls after the light retune; do not infer a general mutation-level verdict until the requested 15x15 repeat and a more comparable Growth-only control are run. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/ecology_nerf_120x120_g50_seed220822`.
- **Corrected 120x120 result (2026-08-23):** After extending both Ecology strategies with the full `TST_Arch01_GrowthResilience` suffix and fallback profile, the same 50-game, slot-rotated, nutrient/mycovariant-disabled probe (`ecology_nerf_arch01suffix_120x120_g50_seed220822`) was rerun with the same seed. `TST_EcologyFrontierFirst` led with 16/50 wins (32.0%; 2,488.02 average living cells, 1,880.50 dead cells, 3.38 toxins), followed by `TST_Arch01_GrowthResilience` at 15/50 (30.0%; 2,230.12 living, 1,010.30 dead, 3.24 toxins), `TST_EcologyCrustFirst` at 13/50 (26.0%; 2,417.12 living, 1,772.62 dead, 3.54 toxins), and `TST_Arch04_DriftGrowth` at 6/50 (12.0%; 1,887.32 living, 698.12 dead, 24.56 toxins). The prior 120x120 result is not evidence that the retuned Ecology mutations are underpowered: its two Ecology AIs lacked Arch01's late-game runway. Repeat this corrected lineup on 15x15 before making a mutation-balance call. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/ecology_nerf_arch01suffix_120x120_g50_seed220822`.
- **Corrected 15x15 result (2026-08-23):** The same corrected lineup, controls, 50-game count, seed, and slot rotation on `ecology_nerf_arch01suffix_15x15_g50_seed220822` had zero parity mismatches. `TST_EcologyFrontierFirst` remained first at 16/50 wins (32.0%; 31.50 average living cells, 37.64 dead, 3.04 toxins). `TST_Arch01_GrowthResilience` was next at 15/50 (30.0%; 32.26 living, 20.20 dead, 2.78 toxins), `TST_EcologyCrustFirst` at 10/50 (20.0%; 29.00 living, 33.52 dead, 2.96 toxins), and `TST_Arch04_DriftGrowth` at 9/50 (18.0%; 30.02 living, 8.10 dead, 2.72 toxins). Small boards did not amplify the Ecology pair as predicted: Frontier-first held its large-board win rate while Crust-first lost six points, reducing the Ecology pair's combined share from 58% (120x120) to 52% (15x15). Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/ecology_nerf_arch01suffix_15x15_g50_seed220822`.
- **Detrital Enzymes (2026-08-23):** The Tier-3 dead-matter Ecology branch is implemented. It requires Crustward Tropism 1 (and therefore Aerated Frontier 10), costs 3 mutation points per upgrade, and grants +1.0 percentage point growth chance per level for legal targets orthogonally adjacent to non-toxic dead cells. At level 5, targets beside two or more qualifying dead cells gain an additional +1.0 percentage point. Dead cells from any owner qualify, further dead neighbors do not stack, all effects remain under the shared 25% Ecology cap, and Simulation records normal/dense qualifying attempts and attributable successes.
- **Detrital-finish 120x120 result (2026-08-23):** The requested repeat used the same four fixed Testing strategies, 50-game count, seed (220822), slot rotation, and nutrient/mycovariant-disabled controls, but both Ecology AIs now finish Detrital Enzymes before their shared Arch01 Growth/Resilience suffix. `TST_Arch01_GrowthResilience` and `TST_Arch04_DriftGrowth` each won 25/50 (50.0%; 2,797.44 and 2,669.40 average living cells, respectively). `TST_EcologyFrontierFirst` won 0/50 (1,495.38 living, 1,731.88 dead, 3.94 toxins) and `TST_EcologyCrustFirst` won 0/50 (1,401.68 living, 1,653.24 dead, 3.14 toxins). The run had zero parity mismatches. On this board size, maxing all three Ecology mutations before Growth is decisively too slow for this matchup. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/ecology_detritalfinish_120x120_g50_seed220822`.
- **Detrital-finish 15x15 result (2026-08-23):** The matching 50-game 15x15 probe, with identical seed/rotation/disabled-system controls, also had zero parity mismatches. `TST_Arch01_GrowthResilience` and `TST_Arch04_DriftGrowth` each won 17/50 (34.0%; 33.90 and 33.38 average living cells). `TST_EcologyFrontierFirst` won 12/50 (24.0%; 26.02 living, 37.82 dead, 2.52 toxins), while `TST_EcologyCrustFirst` won 4/50 (8.0%; 25.02 living, 33.94 dead, 2.46 toxins). Unlike 120x120, the Ecology finish is still viable on the small board, but it trails both controls; Frontier-first is materially better than Crust-first in this ordering. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/ecology_detritalfinish_15x15_g50_seed220822`.
- **Autolytic Surge (2026-08-23):** Formerly Hyphal Surge (the mutation ID/type remains stable for save compatibility), this Tier-2 Mycelial Surge now grants +2.0 percentage points cardinal growth chance and +1.2 percentage points random decay chance per level while active, for three rounds. It retains Mycelial Bloom 5 as its prerequisite and its existing activation-cost formula. `TST_EcologyAutolyticDetrital` exercises the approved staged plan: Aerated max, Autolytic 1, Crustward max, Autolytic 2, Creeping 1, Autolytic 3, Detrital max, Necrophytic Bloom max, Creeping max.
- **Autolytic Ecology 120x120 result (2026-08-23):** The fixed eight-player, 100-game run `autolytic_ecology_120x120_8p_g100_seed230823` used seed 230823, rotated slots, disabled nutrient patches/mycovariants, and replaced prior lowest performer `TST_HyphalSurgeTempo` with `TST_EcologyAutolyticDetrital`. It had zero parity mismatches. `TST_EarlyReclaimerSwarm` won 37/100 (37.0%; 1,251.87 average living cells), `TST_Arch01_GrowthResilience` 31/100 (31.0%; 1,215.93), `TST_Arch04_DriftGrowth` 18/100 (18.0%; 1,048.60), `TST_HyperEconomyRamp` 13/100 (13.0%; 833.31), and `TST_EcologyFrontierFirst` 1/100 (1.0%; 626.17). `TST_EcologyCrustFirst`, `TST_FortressResilience`, and `TST_EcologyAutolyticDetrital` won 0/100; the new Autolytic AI averaged 505.28 living cells, 1,282.92 dead cells, and 3.89 toxins. The staged surge route did create a high-death footprint, but it did not yet translate into competitive board control. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/autolytic_ecology_120x120_8p_g100_seed230823`.
- **Autolytic Reclaimer testing AI (2026-08-23):** `TST_EcologyAutolyticReclaimer` replaces `TST_EcologyCrustFirst` in the next eight-player comparison. It differs from the Detrital variant by using the first Autolytic Surge to set up `Necrosporulation` max before the second/third activations, then `Regenerative Hyphae` max after Detrital Enzymes. This directly converts friendly random deaths into remote colonization and later friendly-corpse reclamation; it deliberately omits Necrophytic Bloom because neutral compost patches consume dead matter without giving this route a direct owned payoff.
- **Autolytic Reclaimer 120x120 result (2026-08-23):** The requested fixed eight-player, 100-game comparison `autolytic_reclaimer_120x120_8p_g100_seed230823` used seed 230823, rotated slots, disabled nutrient patches/mycovariants, and replaced `TST_EcologyCrustFirst` with `TST_EcologyAutolyticReclaimer`. It had zero parity mismatches. The Reclaimer won 100/100 (100.0%; 3,443.42 average living cells, 1,675.83 dead cells, 4.03 toxins). All controls and the two other Ecology routes won 0/100: `TST_EarlyReclaimerSwarm` averaged 874.53 living cells, `TST_Arch01_GrowthResilience` 824.98, `TST_Arch04_DriftGrowth` 708.11, `TST_EcologyFrontierFirst` 689.85, and `TST_EcologyAutolyticDetrital` 605.25. This is an unequivocal dominance result; do not treat the full Reclaimer route as balanced without isolating whether early Necrosporulation, Autolytic Surge, or their interaction is responsible. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/autolytic_reclaimer_120x120_8p_g100_seed230823`.
- **Reclaimer dominance diagnosis (2026-08-23):** Controlled 50-game repeats used the same eight-player anchors, 120x120 board, seed 230823, slot rotation, and nutrient/mycovariant-disabled setup. `TST_NecroRush_Bare`—Necrosporulation/Regenerative Hyphae/Creeping Mold while excluding Autolytic Surge and all Ecology—won 1/50 (2.0%; 512.36 living cells). `TST_NecroRush_AeratedOnly`—the same route plus only Aerated Frontier, while still excluding Autolytic Surge, Crustward Tropism, and Detrital Enzymes—won 48/50 (96.0%; 3,221.08 living cells). Thus the imbalance is the **Aerated Frontier × early max-Necrosporulation feedback loop**; neither Autolytic Surge nor later Ecology branches are required. During diagnosis, `excludedMutationIds` was found to filter paid AI spending but not Mutator Phenotype auto-upgrades; the Core auto-upgrade pool now honors `ParameterizedSpendingStrategy` exclusions, with focused regression coverage. Artifacts: `necro_rush_bare_clean_120x120_g50_seed230823`, `necro_rush_aeratedonly_120x120_g50_seed230823`.
- **Aerated age-cap validation (2026-08-23):** An earlier, temporary younger-than-five-cycle interpretation reduced the Aerated-only/Necro probe from 48/50 wins (96.0%; 3,221.08 average living cells) to 30/50 (60.0%; 1,862.92) in `necro_rush_aeratedonly_agecap5_120x120_g50_seed230823`, but it did not match the intended direction and has been superseded.
- **Aerated established-cell gate (2026-08-23):** The initial older-than-five-cycle gate (age 6+) gave `TST_NecroRush_AeratedOnly` 0/50 wins (0.0%; 867.12 average living cells) in `necro_rush_aeratedonly_olderthan5_120x120_g50_seed230823`; it was a useful overcorrection probe and has been superseded by the three-cycle boundary below.
- **Aerated older-than-three-cycle validation (2026-08-23):** Aerated Frontier now applies only from living cells **older than three Growth Cycles** (age 4+); focused Core tests cover age 3/4. The exact fixed 50-game Aerated-only/Necro rerun (`necro_rush_aeratedonly_olderthan3_120x120_g50_seed230823`) gave `TST_NecroRush_AeratedOnly` 18/50 wins (36.0%; 1,394.16 average living cells), followed by Arch01 at 26%, Early Reclaimer at 14%, Arch04 at 12%, and HyperEconomy at 12%. It restores the isolated route from the five-cycle gate's 0% without returning to its uncapped 96% dominance; this is a substantially more plausible calibration point, pending a full-roster validation. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/necro_rush_aeratedonly_olderthan3_120x120_g50_seed230823`.
- **Aerated minimum-age-six validation (2026-08-23):** The age boundary was expressed directly as `AeratedFrontierMinimumEligibleGrowthCycleAge = 6`; a living source qualified at age 6 or later (`>=`), rather than using an exclusive “older than five” constant. The fresh exact 50-game rerun reproduced the original 0/50 Aerated-only/Necro result. This was too restrictive and has been superseded by the age-5 midpoint below. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/necro_rush_aeratedonly_minimumage6_120x120_g50_seed230823`.
- **Aerated minimum-age-five validation (2026-08-23):** Aerated Frontier now uses `AeratedFrontierMinimumEligibleGrowthCycleAge = 5`: a living source must be at least five Growth Cycles old (equivalently, strictly older than four cycles). In the exact fixed 50-game rerun (`necro_rush_aeratedonly_minimumage5_120x120_g50_seed230823`), `TST_NecroRush_AeratedOnly` won 8/50 (16.0%; 1,150.62 average living cells). The anchors were closely distributed: Arch01 24%, Early Reclaimer 22%, Arch04 20%, and HyperEconomy 18%. The run had zero parity mismatches. This is materially less dominant than age 4+ (36%) and avoids the age-6+ shutdown (0%); it is the current promising calibration, pending broader roster validation. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/necro_rush_aeratedonly_minimumage5_120x120_g50_seed230823`.
- **Necrophytic Bloom chunked composting (2026-08-23):** Oversized dead-cell clusters were getting weaker relative to their size because the whole cluster only ever received one compost roll per round, so a single miss wasted the round regardless of how much dead matter was available. `GeneticDriftMutationProcessor.ResolveNecrophyticBloomComposting` now partitions each qualifying cluster into contiguous groups of `clusterThreshold` tiles (10 at level 1, down to 6 at max level, via the new `PartitionNecrophyticBloomClusterIntoChunks`) and rolls compost chance independently per group, stopping as soon as the existing 2-patches-per-round cap is hit. Total throughput is unchanged (same per-patch tile cap and per-round cap); only the reliability of large masses actually landing their patches improved. Mutation tooltip copy in `SubstrateEcologyMutationFactory.cs` was updated to describe the per-group rolls. Two new `NecrophyticBloomTests` cover chunk-partition contiguity/coverage and a scripted-RNG case proving one big cluster can now succeed on a later group after an earlier group's roll misses; all 11 pre-existing tests in that file pass unmodified since chunk size equals the prior cluster threshold. Core suite: 585/586 passing (the sole failure, `StrategyCatalogTests.Campaign_progression_board_presets_only_use_cmp_strategy_names`, is pre-existing on `main` and unrelated, confirmed by re-running it with the change stashed out). Core and Simulation builds passed with no warnings; a 2-player 40x40 smoke simulation completed and reported Necrophytic Bloom patches created as expected. Unity Core DLL/PDB were refreshed from the Core build, as expected for any Core change.
...
**Regenerative Hyphae / Necrosporulation tier swap (2026-08-30):**

- Necrosporulation was Tier 3 (Chronoresilient Cytoplasm 5) and Regenerative Hyphae Tier 4 (Necrosporulation 5). Necrosporulation's on-death remote colonization is far stronger than Regenerative Hyphae's local self-reclaim and was under-gated for its tier; the earlier "Reclaimer dominance diagnosis" also isolated an Aerated Frontier x early max-Necrosporulation feedback loop. Swapped the chain: Regenerative Hyphae is now Tier 3 (requires Chronoresilient Cytoplasm 5, 4 pts/level) and Necrosporulation is now Tier 4 (requires Regenerative Hyphae 5, 5 pts/level). Cost to max Necrosporulation rises from ~35 to ~60 prerequisite points.
- Downstream edges unchanged in text but deeper in the graph: Necrohyphal Infiltration (Necrosporulation 5 + Mycotoxin Potentiation 5) and Catabolic Rebirth (Necrosporulation 5 + Mycotoxin Catabolism 5) now sit at a four-edge upstream depth and transitively require Regenerative Hyphae 5. Hypersystemic Regeneration (Regenerative Hyphae 3 + Mycotropic Induction 1) got one edge shallower. Necrotoxic Conversion (Fungicide, Regenerative Hyphae 1) is now cheaper to reach.
- Files: `CellularResilienceMutationFactory` (blocks swapped and reordered so Regenerative Hyphae is built first — `MakeChild` resolves reverse child edges eagerly), `GameBalance` tier comments, `UI_MutationLayoutProvider` (Cellular Resilience rows 2/3 swapped), `Tier3MutationTests` / `Tier4MutationTests` / `MutationProgressSnapshotTests`, `MUTATION_PREREQUISITE_GUIDELINES.md` review hotspots. AI: `CMP_Reclaim_Scavenger_Easy` `maxTier` raised Tier 3 -> Tier 4 so it can still reach Necrosporulation.
