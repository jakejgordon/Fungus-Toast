...
- **Aerated established-cell gate (2026-08-23):** Aerated Frontier now applies only from living cells **older than five Growth Cycles** (age 6+); focused Core tests cover age 5/6. The exact fixed 50-game Aerated-only/Necro rerun (`necro_rush_aeratedonly_olderthan5_120x120_g50_seed230823`) gave `TST_NecroRush_AeratedOnly` 0/50 wins (0.0%; 867.12 average living cells). The anchors won: Early Reclaimer 36%, HyperEconomy 30%, Arch04 26%, and Arch01 8%. This proves the older-than-five gate removes the Aerated/Necro dominance, but it likely overcorrects the isolated route; validate the full roster before treating it as final balance.
