...
- **Aerated minimum-age-six validation (2026-08-23):** The age boundary is now expressed directly as `AeratedFrontierMinimumEligibleGrowthCycleAge = 6`; a living source qualifies at age 6 or later (`>=`), rather than using an exclusive “older than five” constant. This is behaviorally equivalent to the original age-6 gate and avoids the inverted maximum/minimum interpretation. The fresh exact fixed 50-game rerun (`necro_rush_aeratedonly_minimumage6_120x120_g50_seed230823`) reproduced the original result: `TST_NecroRush_AeratedOnly` won 0/50 (0.0%; 867.12 average living cells); Early Reclaimer won 36%, HyperEconomy 30%, Arch04 26%, and Arch01 8%. The run had zero parity mismatches. This supersedes the age-4 calibration above. Artifact: `FungusToast.Simulation/bin/Debug/net8.0/SimulationParquet/necro_rush_aeratedonly_minimumage6_120x120_g50_seed230823`.
