...
- Immediate next implementation target: polish and verify end-of-level moldiness summaries, then add moldiness context to the reward panel itself and continue on campaign pending-state hints.
