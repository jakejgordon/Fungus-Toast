    ...
    public static class AIRoster
    {
        ...
        private static readonly List<IMutationSpendingStrategy> _rawCampaignStrategies = new List<IMutationSpendingStrategy>
        {
            ...
            new ParameterizedSpendingStrategy(
                ...
                mycovariantPreferences: new List<MycovariantPreference>
                {
                    new(MycovariantIds.PlasmidBountyIIIId, 1000, "Largest immediate mutation-point payout for the toxin engine"),
                    new(MycovariantIds.PlasmidBountyIIId, 999, "Second-largest immediate mutation-point payout"),
                    new(MycovariantIds.PlasmidBountyId, 998, "Reliable immediate mutation-point payout"),
                    new(MycovariantIds.AscusWagerId, 997, "Late fallback for a free Tier 5 toxin level")
                },
            ...
            new ParameterizedSpendingStrategy(
                ...
                mycovariantPreferences: new List<MycovariantPreference>
                {
                    new(MycovariantIds.PlasmidBountyIIIId, 1000, "Largest immediate mutation-point payout for the regression engine"),
                    new(MycovariantIds.PlasmidBountyIIId, 999, "Second-largest immediate mutation-point payout"),
                    new(MycovariantIds.PlasmidBountyId, 998, "Reliable immediate mutation-point payout"),
                    new(MycovariantIds.AscusWagerId, 997, "Late fallback for a free Tier 5 regression level")
                }
            ),
            new ParameterizedSpendingStrategy(
        ...
        private static readonly List<IMutationSpendingStrategy> _rawTestingStrategies = new List<IMutationSpendingStrategy>
        {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_NecrotoxinGauntlet_EconomyControl",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MaxEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_NecrotoxinGauntlet_CuratedMycovariants",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MaxEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBroker_EconomyControl",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBroker_CuratedMycovariants",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_CreepingRegression_EconomyControl",
                prioritizeHighTier: true,
                economyBias: EconomyBias.ModerateEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_CreepingRegression_CuratedMycovariants",
                prioritizeHighTier: true,
                economyBias: EconomyBias.ModerateEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_VoltaicRot_EconomyControl",
                prioritizeHighTier: true,
                economyBias: EconomyBias.ModerateEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_VoltaicRot_CuratedMycovariants",
                prioritizeHighTier: true,
                economyBias: EconomyBias.ModerateEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBrokerOffset1_EconomyControl",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBrokerOffset1_CuratedMycovariants",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBrokerOffset3_EconomyControl",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_HarvestBrokerOffset3_CuratedMycovariants",
                prioritizeHighTier: true,
                targetMutationGoals: new List<TargetMutationGoal>
                {
                    new TargetMutationGoal(MutationIds.CreepingMold),
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_ResilientShell_CategoryControl",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MinorEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_ResilientShell_CuratedMycovariants",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MinorEconomy,
                targetMutationGoals: new List<TargetMutationGoal>
                {
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_ReclaimShell_CategoryControl",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MinorEconomy,
                maxTier: MutationTier.Tier3,
                targetMutationGoals: new List<TargetMutationGoal>
            ...
            new ParameterizedSpendingStrategy(
                strategyName: "TST_Campaign_ReclaimShell_CuratedMycovariants",
                prioritizeHighTier: true,
                economyBias: EconomyBias.MinorEconomy,
                maxTier: MutationTier.Tier3,
                targetMutationGoals: new List<TargetMutationGoal>
        ...
        private static readonly UniqueKeyDictionary<StrategyLifecycle> _explicitLifecycleByName =
            new(StringComparer.OrdinalIgnoreCase)
            {
        ...
        private static readonly UniqueKeyDictionary<CounterTag[]> _explicitFavoredAgainstByName =
            new(StringComparer.OrdinalIgnoreCase)
            {
        ...
        private static readonly UniqueKeyDictionary<CounterTag[]> _explicitWeakAgainstByName =
            new(StringComparer.OrdinalIgnoreCase)
            {
        ...
        static AIRoster()
        {
            ...
            AuditMetadataOverrideTargets();
            AuditSurgeBackboneSynergy(TestingStrategies, nameof(TestingStrategies));
        }

        private static void AuditMetadataOverrideTargets()
        {
            var registeredNames = Enum.GetValues(typeof(StrategySetEnum))
            ...
            if (orphanedOverrides.Count > 0)
            {
                throw new InvalidOperationException(
                    $"Metadata overrides target unregistered strategies: {string.Join(", ", orphanedOverrides)}");
            }
        }
            ...
            int cycleIndex = 0)
        {
            ...
            if (numberOfPlayers > sourceStrategies.Count)
            {
                throw new InvalidOperationException(
                    $"Strategy set {strategySet} contains {sourceStrategies.Count} registered strategies but {numberOfPlayers} were requested.");
            }
        ...
        private static StrategyProfile BuildStrategyProfile(StrategyCatalogEntry entry)
        {
            return new StrategyProfile(
                entry.StrategyName,
                entry.StrategySet,
        ...
        public static StrategyStatus GetStatusForStrategy(IMutationSpendingStrategy strategy, StrategySetEnum strategySet)
        {
            ...
            {
                return registered.Metadata.Status;
            }
        ...
        public static StrategyRole GetRoleForStrategy(IMutationSpendingStrategy strategy, StrategySetEnum strategySet)
        {
            ...
            if (registered != null && ReferenceEquals(registered.Strategy, strategy))
            {
                return registered.Metadata.Role;
            }
        ...
        public static StrategyLifecycle GetLifecycleForStrategy(IMutationSpendingStrategy strategy, StrategySetEnum strategySet)
        {
            ...
            if (registered != null && ReferenceEquals(registered.Strategy, strategy))
            {
                return registered.Metadata.Lifecycle;
            }
        ...
        public static CampaignDifficulty? GetCampaignDifficultyForStrategy(IMutationSpendingStrategy strategy, StrategySetEnum strategySet)
        {
            ...
            if (registered != null && ReferenceEquals(registered.Strategy, strategy))
            {
                return registered.Metadata.CampaignDifficulty;
            }
        ...
        public static IReadOnlyCollection<CounterTag> GetFavoredAgainstForStrategy(IMutationSpendingStrategy strategy)
        {
            ...
            if (registered != null)
            {
                return registered.Metadata.FavoredAgainst;
            }
        ...
        public static IReadOnlyCollection<CounterTag> GetWeakAgainstForStrategy(IMutationSpendingStrategy strategy)
        {
            ...
            if (registered != null)
            {
                return registered.Metadata.WeakAgainst;
            }
