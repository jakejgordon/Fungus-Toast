...
namespace FungusToast.Core.Config
{
    public static class GameBalance
    {
        ...
        public const float BaseRandomDecayChance = .032f;
        ...
        public const float MycotoxinFissionEffectPerLevel = 0.06f;
        public const int MycotoxinFissionMaxLevel = 3;
        public const int MycotoxinFissionToxinDropsPerLevel = 3;
        ...
        public const float MycotropicInductionEffectPerLevel = 0.13f;
        ...
        public const int NecrophyticBloomBaseClusterThreshold = 10;
        public const float NecrophyticBloomBaseCompostChance = 0.20f;
        public const int NecrophyticBloomClusterThresholdReductionPerLevel = 1;
        public const float NecrophyticBloomCompostChanceIncreasePerLevel = 0.05f;
        public const int NecrophyticBloomPatchTileReduction = 2;
        public const int NecrophyticBloomMaxPatchSize = 10;
        public const int NecrophyticBloomMaxPatchesPerRound = 2;
