...
namespace FungusToast.Core.Metrics
{
    public interface ISimulationObserver
    {
        ...
        void RecordFilamentOverdrive(int playerId, int bonusCellsCreated) { }
        ...
        /// <summary>A planned, affordable, unlocked surge was left unfired because the board did not reward it yet.</summary>
        void RecordAiSurgeOpportunityDeclined(int playerId, int mutationId) { }
        ...
        void RecordAeratedFrontierAttempt(int playerId) { }
        void RecordAeratedFrontierBonusGrowth(int playerId) { }
        void RecordCrustwardTropismAttempt(int playerId) { }
        void RecordCrustwardTropismBonusGrowth(int playerId) { }
        void RecordCrustwardTropismAutomaticGrowth(int playerId) { }
        void RecordDetritalEnzymesAttempt(int playerId) { }
        void RecordDetritalEnzymesBonusGrowth(int playerId) { }
        void RecordDetritalEnzymesDenseDeadMatterAttempt(int playerId) { }
        ...
        void RecordToxinborneSeedingAttempt(int playerId) { }
        void RecordToxinborneSeedingBonusGrowth(int playerId) { }
        void RecordToxinborneSeeding(int playerId, bool toxinRelocated, bool carriedCellLanded) { }
        ...
        void RecordSeptalSealResistance(int playerId, int count) { }
        ...
        void RecordNecroticClearanceCorpsesCleared(int playerId, int count, int contestedCount) { }
        ...
        void RecordMycelialCrescendoSurge(int playerId, string surgeName);
    }
}
