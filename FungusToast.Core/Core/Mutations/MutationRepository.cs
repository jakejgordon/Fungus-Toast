    ...
    public static class MutationRepository
    {
        public static (Dictionary<int, Mutation> all, Dictionary<int, Mutation> roots) BuildFullMutationSet()
        {
            ...
            MakeRoot(new Mutation(MutationIds.MycelialBloom, "Mycelial Bloom",
                $"Each level grants a {FormatPercent(GameBalance.MycelialBloomEffectPerLevel)} increased chance to grow in the four cardinal directions.",
            ...
            MakeRoot(new Mutation(MutationIds.HomeostaticHarmony, "Homeostatic Harmony",
                $"Each level reduces self-death probability during decay by {FormatPercent(GameBalance.HomeostaticHarmonyEffectPerLevel)}.",
            ...
            MakeRoot(new Mutation(MutationIds.SilentBlight, "Silent Blight",
                $"Each level increases the base decay chance of enemy cells by {FormatPercent(GameBalance.SilentBlightEffectPerLevel)}.",
            ...
            MakeRoot(new Mutation(MutationIds.AdaptiveExpression, "Adaptive Expression",
                $"Each level grants a {FormatPercent(GameBalance.AdaptiveExpressionEffectPerLevel)} chance to gain an additional mutation point each round.",
            ...
            MakeChild(new Mutation(MutationIds.ChronoresilientCytoplasm, "Chronoresilient Cytoplasm",
                $"Each level increases the age threshold before death risk begins by {FormatFloat(GameBalance.ChronoresilientCytoplasmEffectPerLevel)} growth cycles.",
            ...
            MakeChild(new Mutation(MutationIds.EncystedSpores, "Encysted Spores",
                $"Each level grants a {FormatPercent(GameBalance.EncystedSporesEffectPerLevel)} death pressure bonus against enemies surrounded on three or more sides.",
            ...
            MakeChild(new Mutation(MutationIds.MutatorPhenotype, "Mutator Phenotype",
                $"Each level grants a {FormatPercent(GameBalance.MutatorPhenotypeEffectPerLevel)} chance to automatically upgrade a random mutation each round.",
            ...
            MakeChild(new Mutation(MutationIds.Necrosporulation, "Necrosporulation",
                $"Each level grants a {FormatPercent(GameBalance.NecrosporulationEffectPerLevel)} chance to spawn a new cell when a fungal cell dies.",
            ...
            MakeChild(new Mutation(MutationIds.PutrefactiveMycotoxin, "Putrefactive Mycotoxin",
                $"Each level adds a {FormatPercent(GameBalance.PutrefactiveMycotoxinEffectPerLevel)} death chance to enemy cells adjacent to tiles you control.",
            ...
            MakeChild(new Mutation(MutationIds.AnabolicInversion, "Anabolic Inversion",
                $"Each level adds a {FormatPercent(GameBalance.AnabolicInversionGapBonusPerLevel)} chance to earn {GameBalance.AnabolicInversionPointsPerUpgrade} bonus points when you trail in living cells.",
            ...
            MakeChild(new Mutation(MutationIds.MycotropicInduction, "Mycotropic Induction",
                $"Each level increases all diagonal growth probabilities by {FormatPercent(GameBalance.MycotropicInductionEffectPerLevel)}.",
            ...
            void AddTendril(int id, string dir)
            {
                MakeChild(new Mutation(id, $"Tendril {dir}",
                    $"Each level grants a {FormatPercent(GameBalance.DiagonalGrowthEffectPerLevel)} chance to grow in the {dir.ToLower()} direction.",
