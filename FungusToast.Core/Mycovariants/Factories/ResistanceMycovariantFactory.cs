...
namespace FungusToast.Core.Mycovariants
{
    internal static class ResistanceMycovariantFactory
    {
        ...
        private static Mycovariant HyphalResistanceTransfer() => new Mycovariant
        {
            ...
            Description = $"For the rest of the game, after each Growth Phase, each of your non-Resistant living cells adjacent (including diagonally) to a Resistant cell becomes Resistant with {MycovariantGameBalance.HyphalResistanceTransferChance * 100f:0}% chance.",
        ...
        private static Mycovariant SeptalAlarm() => new Mycovariant
        {
            ...
            Name = "Septal Alarm",
            Description = $"For the rest of the game, whenever one of your living cells dies, each of your non-Resistant living cells orthogonally adjacent (up / down / left / right) to it has a {MycovariantGameBalance.SeptalAlarmResistanceChance * 100f:0}% chance to become Resistant.",
        ...
        private static Mycovariant SeptalSeal() => new Mycovariant
        {
            ...
            Name = "Septal Seal",
            Description = $"One-time on draft: a random share of your non-Resistant living cells become Resistant: {MycovariantGameBalance.SeptalSealResistancePortionNumerator * 100f:0}% divided by the number of Mycovariants you already own, rounded up to at least 1 cell. Resistant cells cannot be killed, infested, or poisoned.",
