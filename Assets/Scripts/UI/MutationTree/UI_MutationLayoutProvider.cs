    ...
    public static class MutationLayoutProvider
    {
        public static Dictionary<int, MutationLayoutMetadata> GetDefaultLayout()
        {
            return new Dictionary<int, MutationLayoutMetadata>
            {
                ...
                { 5, new MutationLayoutMetadata(0, 1, MutationCategory.Growth) },         // Tendril Northwest
                { 6, new MutationLayoutMetadata(0, 2, MutationCategory.Growth) },         // Tendril Northeast
                { 7, new MutationLayoutMetadata(0, 3, MutationCategory.Growth) },         // Tendril Southeast
                { 8, new MutationLayoutMetadata(0, 4, MutationCategory.Growth) },         // Tendril Southwest
