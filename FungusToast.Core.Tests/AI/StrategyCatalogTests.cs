...
public class StrategyCatalogTests
{
    ...
    [Fact]
    public void Pulsar_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Surge_Pulsar_Easy"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_Pulsar_CategoryControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_Pulsar_CuratedMycovariants"]);
    ...
    [Fact]
    public void Resilient_Canopy_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_TierCap_GrowthResilience_Easy"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_ResilientCanopy_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_ResilientCanopy_CuratedMycovariants"]);
    ...
    [Fact]
    public void Late_Spike_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Economy_LateSpike_Hard"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_LateSpike_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_LateSpike_CuratedMycovariants"]);
    ...
    [Fact]
    public void Growth_Pressure_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Growth_Pressure_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_GrowthPressure_CategoryControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_GrowthPressure_CuratedMycovariants"]);
    ...
    [Fact]
    public void Putrid_Tendrils_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Growth_PutridTendrils_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_PutridTendrils_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_PutridTendrils_CuratedMycovariants"]);
    ...
    [Fact]
    public void Beacon_Sprinter_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Surge_BeaconSprinter_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_BeaconSprinter_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_BeaconSprinter_CuratedMycovariants"]);
    ...
    [Fact]
    public void Growth_Tempo_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Surge_GrowthTempo_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_GrowthTempo_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_GrowthTempo_CuratedMycovariants"]);
    ...
    [Fact]
    public void Anabolic_Rebirth_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Control_AnabolicRebirth_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_AnabolicRebirth_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_AnabolicRebirth_CuratedMycovariants"]);
    ...
    [Fact]
    public void Rebirth_Furnace_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["CMP_Control_RebirthFurnace_Medium"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RebirthFurnace_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RebirthFurnace_CuratedMycovariants"]);
    ...
    [Fact]
    public void Voltaic_Bloom_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["AI12"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_VoltaicBloom_CategoryControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_VoltaicBloom_CuratedMycovariants"]);
    ...
    public void Legacy_Hoardspore_Regent_mycovariant_experiment_changes_only_the_preference_plan()
    {
        ...
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_HoardsporeRegentLegacy_CategoryControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_HoardsporeRegentLegacy_CuratedMycovariants"]);
    ...
    [Fact]
    public void Rejuvenation_Engine_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["AI5"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RejuvenationEngine_NoPreferenceControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RejuvenationEngine_CuratedMycovariants"]);
    ...
    [Fact]
    public void Rooted_Canopy_mycovariant_experiment_changes_only_the_preference_plan()
    {
        var campaign = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.CampaignStrategiesByName["AI6"]);
        var control = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RootedCanopy_CategoryControl"]);
        var treatment = Assert.IsType<ParameterizedSpendingStrategy>(AIRoster.TestingStrategiesByName["TST_Campaign_RootedCanopy_CuratedMycovariants"]);
