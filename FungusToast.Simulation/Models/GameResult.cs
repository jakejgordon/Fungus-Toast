        ...
        public static GameResult From(GameBoard board, List<Player> players, int turns, SimulationTrackingContext tracking)
        {
            ...
            foreach (var player in players)
            {
                ...
                var pr = new PlayerResult
                {
                    ...
                    NecrophyticBloomPatchesCreated = tracking.GetNecrophyticBloomPatchCreationCount(player.PlayerId),
                    ...
                    DirectedVectorGrowths = tracking.GetDirectedVectorGrowthCount(player.PlayerId),
                    DirectedVectorInfested = tracking.GetDirectedVectorInfested(player.PlayerId),
                    DirectedVectorReclaimed = tracking.GetDirectedVectorReclaimed(player.PlayerId),
                    DirectedVectorCatabolicGrowth = tracking.GetDirectedVectorCatabolicGrowth(player.PlayerId),
                    DirectedVectorAlreadyOwned = tracking.GetDirectedVectorAlreadyOwned(player.PlayerId),
                    ...
                    DetritalEnzymesAttempts = tracking.GetDetritalEnzymesAttempts(player.PlayerId),
                    DetritalEnzymesBonusGrowths = tracking.GetDetritalEnzymesBonusGrowths(player.PlayerId),
                    DetritalEnzymesDenseDeadMatterAttempts = tracking.GetDetritalEnzymesDenseDeadMatterAttempts(player.PlayerId),
